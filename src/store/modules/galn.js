...
const getters = {
    galnPrevLotteryAndValue(state){ // 和值
...
const mutations = {
    galnSetGame(state, payload){
        if(typeof payload === 'undefined'){
            console.error('payload is not defined in galnSetGame()!');
            return;
        }
    ...
    galnSetPrevLottery(state, payload){
        if(typeof payload === 'undefined'){
            console.error('payload is not defined in galnSetPrevLottery()!');
            return;
        }
    ...
    galnSetCurrentLottery(state, payload){
        if(typeof payload === 'undefined'){
            console.error('payload is not defined in galnSetCurrentLottery()!');
            return;
        }
    ...
    galnSetCategories(state, payload){
        if(typeof payload === 'undefined'){
            console.error('payload is not defined in galnSetCategories()!');
            return;
        }
    ...
    galnSetProducts(state, payload){
        if(typeof payload === 'undefined'){
            console.error('payload is not defined in galnSetProducts()!');
            return;
        }
    ...
    galnSetCart(state, payload){
        if(typeof payload === 'undefined'){
            console.error('payload is not defined in galnSetCart()!');
            return;
        }
        state.cart = payload;
    }
