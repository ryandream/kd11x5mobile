...
const getters = {
    gajxPrevLotteryAndValue(state){ // 和值
...
const mutations = {
    gajxSetGame(state, payload){
        if(typeof payload === 'undefined'){
            console.error('payload is not defined in gajxSetGame()!');
            return;
        }
    ...
    gajxSetPrevLottery(state, payload){
        if(typeof payload === 'undefined'){
            console.error('payload is not defined in gajxSetPrevLottery()!');
            return;
        }
    ...
    gajxSetCurrentLottery(state, payload){
        if(typeof payload === 'undefined'){
            console.error('payload is not defined in gajxSetCurrentLottery()!');
            return;
        }
    ...
    gajxSetCategories(state, payload){
        if(typeof payload === 'undefined'){
            console.error('payload is not defined in gajxSetCategories()!');
            return;
        }
    ...
    gajxSetProducts(state, payload){
        if(typeof payload === 'undefined'){
            console.error('payload is not defined in gajxSetProducts()!');
            return;
        }
    ...
    gajxSetCart(state, payload){
        if(typeof payload === 'undefined'){
            console.error('payload is not defined in gajxSetCart()!');
            return;
        }
        state.cart = payload;
    }
